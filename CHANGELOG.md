...
[//]: # (+ Revised: 	2026/08/04 20:01:33.648785 )
[//]: # ( ---------------------------------------------------------------------- )
...
- **Condense/expand toggle on the current PBL text (`docs/index.html`)** — a pill button in the v2.0 license card's header lets the full text be collapsed after reading, without folding it back into a `<details>` accordion (which would re-introduce the version-list framing described below).
