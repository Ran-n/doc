...
[//]: # (+ Created: 	2026/06/18 12:58:21.551607 )
[//]: # (+ Revised: 	2026/06/18 12:58:21.551607 )
[//]: # ( ---------------------------------------------------------------------- )
...
to generate revenue, you owe a share of that revenue to the original author.
This applies regardless of how much the code was changed. If this code is
in the chain, the author is in the chain.
...
You are free to:
  ...
  - Distribute original or modified versions, provided this license is kept
    intact and the original author is credited
...
1. ATTRIBUTION
   ...
   credit the original author:  Ran#  <ran.hash@proton.me>
...
3. COMMERCIAL USE REQUIRES AGREEMENT
   ...
   If your use is commercial, you must contact the author before deploying
...
relabeling to avoid attribution — revokes all rights granted by this license
immediately and permanently.

The author reserves the right to pursue compensation for unlicensed
commercial use retroactively.
